...
<body>
	...
	<div style="text-align: center;">
		<form>
			<p>Serial No: <input type="text" id="id" class="id"  placeholder="Serial Number"></p>

		<p>Author Name: <input type="text" id="author" class="author"  placeholder="Author Name"></p>
		<p>Book Name: <input type="text" id="book" class="book" placeholder="Book Name"></p>
		<P>Image Location: <input type="text" id="image" class="image" placeholder="Image Location"></P>
		<p>Linked file: <input type="text" id="file" class="file" placeholder="File Location"></p>
		<br>
		<input type="button" id="submit" onclick="submitData()" value="Update">
		<br>
	</form>
		</div>
	<br>
